...
if __name__ == "__main__":
    ...
    for n in nn:
        f = open(f"random-simple-polygon-generation-master/src-generate/dataset/case_{n}.txt", "r")
        ...
        # output for C code:
        f = open(f"random-simple-polygon-generation-master\src-generate\Cinput\c_case_{n}.txt", "w")
        f.write(str(n))
        f.write("\n")
        ...
        #print(xs, ys)
        plt.plot(xs, ys)
        #plt.savefig(f"random-simple-polygon-generation-master\src-generate\simplePolygonFig\case_{n}.png")
        plt.show()
