...
# Example usage:
image_files = [f"code/tool/figure/lee/case_in_debug_{_}.png" for _ in range(11)] # edit link and range
output_gif = "code/tool/figure/lee/animated_debug.gif" # edit link 
frame_duration = 10  # 200 milliseconds per frame
